         ...
         (case sym
           ...
           [($native-fiber-switch-entry)
            (let ([request-disp
              ...
              `(lambda ,(make-named-info-lambda '$native-fiber-switch-entry '(1)) 0 ()
                 ,(%seq
                    ;; ac1 retains the heap request while sfp changes from the
                    ;; source stack to the target stack.  Everything that can
                    ;; allocate has already happened in the Scheme wrapper.
                    (set! ,(ref-reg %ac1) ,(make-arg-opnd 1))
                    (set! ,%ac0 ,(%mref ,(ref-reg %ac1) ,(request-disp 3)))
                    (set! ,%td ,(%mref ,(ref-reg %ac1) ,(request-disp 2)))
                    (if ,(%inline eq? ,%td ,(%constant sfalse))
                        (nop)
                        ,(%seq
                           (set! ,%ts ,(%tc-ref scheme-stack))
                           (set! ,(%mref ,%td ,(constant continuation-stack-disp)) ,%ts)
                           (set! ,%ts ,(%tc-ref scheme-stack-size))
                           (set! ,(%mref ,%td ,(constant continuation-stack-length-disp)) ,%ts)
                           (set! ,%ts ,(%tc-ref scheme-stack))
                           (set! ,%ts ,(%inline - ,%sfp ,%ts))
                           (set! ,(%mref ,%td ,(constant continuation-stack-clength-disp)) ,%ts)
                           (set! ,%ts ,(%tc-ref stack-link))
                           (set! ,(%mref ,%td ,(constant continuation-link-disp)) ,%ts)
                           (set! ,%ts ,%ref-ret)
                           (set! ,(%mref ,%td ,(constant continuation-return-address-disp)) ,%ts)
                           (set! ,%ts ,(%tc-ref winders))
                           (set! ,(%mref ,%td ,(constant continuation-winders-disp)) ,%ts)
                           (set! ,%ts ,(%tc-ref attachments))
                           (set! ,(%mref ,%td ,(constant continuation-attachments-disp)) ,%ts)))
                    (set! ,%xp ,(%mref ,(ref-reg %ac1) ,(request-disp 0)))
                    (set! ,%ts ,(%mref ,(ref-reg %ac1) ,(request-disp 4)))
                    (set! ,(%mref ,%xp ,(constant native-fiber-control-disp)) ,%ts)
                    (set! ,%td ,(%mref ,(ref-reg %ac1) ,(request-disp 1)))
                    ...
                    (set! ,%ts ,(%mref ,(ref-reg %ac1) ,(request-disp 5)))
                    (set! ,(%mref ,%td ,(constant native-fiber-control-disp)) ,%ts)
                    (set! ,(%tc-ref current-native-fiber) ,%td)
                    ...
                    (set! ,(%mref ,%xp ,(constant continuation-attachments-disp)) ,(%constant snil))
                    (if ,(%inline eq?
                           ,(%mref ,(ref-reg %ac1) ,(request-disp 7))
                           ,(%constant sfalse))
                        (nop)
                        (set! ,(%tc-ref cached-frame) ,%xp))
                    (if ,(%inline eq?
                           ,(%mref ,(ref-reg %ac1) ,(request-disp 6))
                           ,(%constant sfalse))
                        (jump ,%ts (,%ac0))
                        ,(%seq
                           (set! ,(ref-reg %cp)
