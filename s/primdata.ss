...
(define-symbol-flags* ([libraries (chezscheme async)] [flags system proc])
  (run-async [flags])
  (spawn-task [flags])
  (task? [flags])
  (task-id [flags])
  ...
  (task-join [flags])
  (task-join-operation [flags])
  (task-cancel! [flags])
  (task-yield [flags])
  (async-sleep [flags])
  (current-async-task [flags])
  (current-async-scheduler [flags])
  (task-current-wait [flags])
  (task-profile [flags])
  (task-context [flags])
  (task-stack-snapshot [flags])
  (async-dynamic-wind [flags])
  (make-task-group [flags])
  (task-group? [flags])
  (task-group-wait [flags])
  (make-async-cancellation-condition [flags])
  (async-cancellation-condition? [flags])
  (async-cancellation-reason [flags])
  (async-scheduler? [flags])
  (async-scheduler-task-count [flags])
  (async-scheduler-turn-count [flags])
  (async-scheduler-suspension-count [flags])
  (async-scheduler-wakeup-count [flags])
  (async-scheduler-profile [flags])
  (async-scheduler-trace [flags])
  (async-scheduler-trace-clear! [flags])
)

(define-symbol-flags* ([libraries (chezscheme async syntax)] [flags keyword])
  ((async-syntax: async) [flags])
  ((async-syntax: async/options) [flags])
  ((async-syntax: go) [flags])
  ((async-syntax: go/options) [flags])
  ((async-syntax: await) [flags])
  ((async-syntax: select-operation) [flags])
  ((async-syntax: select) [flags])
  ((async-syntax: with-timeout) [flags])
  ...
  ((async-syntax: with-async-rw-mutex) [flags])
  ((async-syntax: with-async-read-mutex) [flags])
  ((async-syntax: with-async-wait-group) [flags])
)

(define-symbol-flags* ([libraries (chezscheme async context)] [flags system proc])
  (make-async-context [flags])
  (async-context? [flags])
  (async-context-cancel! [flags])
  (async-context-canceled? [flags])
  (async-context-reason [flags])
  (async-context-done-operation [flags])
  (async-context-with-timeout [flags])
  (async-context-with-deadline [flags])
  (current-async-context [flags])
  (call-with-async-context [flags])
  (call-with-async-timeout [flags])
  (perform-operation/context [flags])
)

(define-symbol-flags* ([libraries (chezscheme async operations)] [flags system proc])
  (make-operation [flags])
  (operation? [flags])
  (perform-operation [flags])
  (wrap-operation [flags])
  (choice-operation [flags])
  (always-operation [flags])
  (never-operation [flags])
  (sleep-operation [flags])
  (make-future [flags])
  (future? [flags])
  (future-fulfil! [flags])
  (future-fail! [flags])
  (future-operation [flags])
  (future-get [flags])
)

(define-symbol-flags* ([libraries (chezscheme async channels)] [flags system proc])
  (make-channel [flags])
  (channel? [flags])
  (make-channel-closed-condition [flags])
  (channel-closed-condition? [flags])
  (channel-closed-reason [flags])
  (channel-close! [flags])
  (channel-closed? [flags])
  (channel-put-operation [flags])
  (channel-get-operation [flags])
  (channel-receive-operation [flags])
  (channel-put [flags])
  (channel-get [flags])
...
(define-symbol-flags* ([libraries (chezscheme async sync)] [flags system proc])
  ...
  (make-async-rw-mutex [flags])
  (async-rw-mutex? [flags])
  (async-rw-mutex-acquire-operation [flags])
  (async-rw-mutex-read-acquire-operation [flags])
  (async-rw-mutex-acquire [flags])
  (async-rw-mutex-read-acquire [flags])
  (async-rw-mutex-release! [flags])
  (async-rw-mutex-read-release! [flags])
  (call-with-async-rw-mutex [flags])
  (call-with-async-read-mutex [flags])
  (make-async-wait-group [flags])
  (async-wait-group? [flags])
  (async-wait-group-add! [flags])
  (async-wait-group-done! [flags])
  (async-wait-group-wait-operation [flags])
  (async-wait-group-wait [flags])
  (spawn-task/async-wait-group [flags])
  (make-async-once [flags])
  (async-once? [flags])
  (async-once-run! [flags])
  (make-async-condition [flags])
  (async-condition? [flags])
  (async-condition-mutex [flags])
  (async-condition-wait [flags])
  (async-condition-signal! [flags])
  (async-condition-broadcast! [flags])
)

(define-symbol-flags* ([libraries (chezscheme async io errors)]
                       [flags system proc])
  (make-async-io-condition [feature libuv] [flags])
  (async-io-condition? [feature libuv] [flags])
  (async-io-condition-operation [feature libuv] [flags])
  (async-io-condition-handle [feature libuv] [flags])
  (async-io-condition-path [feature libuv] [flags])
  (async-io-condition-code [feature libuv] [flags])
  (async-io-error-name [feature libuv] [flags])
  (async-io-error-message [feature libuv] [flags])
)

(define-symbol-flags* ([libraries (chezscheme async io stream)]
                       [flags system proc])
  (tcp-listen [feature libuv] [flags])
  (tcp-listener? [feature libuv] [flags])
  (tcp-listener-close [feature libuv] [flags])
  (tcp-accept-operation [feature libuv] [flags])
  (tcp-accept [feature libuv] [flags])
  (tcp-connect-operation [feature libuv] [flags])
  (tcp-connect [feature libuv] [flags])
  (pipe-listen [feature libuv] [flags])
  (pipe-connect-operation [feature libuv] [flags])
  (pipe-connect [feature libuv] [flags])
  (async-stream? [feature libuv] [flags])
  (tcp-stream? [feature libuv] [flags])
  (pipe-stream? [feature libuv] [flags])
  (stream-close [feature libuv] [flags])
  (stream-closed? [feature libuv] [flags])
  (stream-read-operation [feature libuv] [flags])
  (stream-read [feature libuv] [flags])
  (stream-write-operation [feature libuv] [flags])
  (stream-write [feature libuv] [flags])
  (stream-shutdown [feature libuv] [flags])
  (async-stream->binary-input-port [feature libuv] [flags])
  (async-stream->binary-output-port [feature libuv] [flags])
  (async-stream->binary-input/output-port [feature libuv] [flags])
)

(define-symbol-flags* ([libraries (chezscheme async io dns)]
                       [flags system proc])
  (dns-lookup-operation [feature libuv] [flags])
  (dns-lookup [feature libuv] [flags])
  (dns-reverse-operation [feature libuv] [flags])
  (dns-reverse [feature libuv] [flags])
)

(define-symbol-flags* ([libraries (chezscheme async io system)]
                       [flags system proc])
  (random-bytevector-operation [feature libuv] [flags])
  (random-bytevector [feature libuv] [flags])
  (system-high-resolution-time [feature libuv] [flags])
  (system-memory-info [feature libuv] [flags])
  (system-uptime [feature libuv] [flags])
  (system-load-average [feature libuv] [flags])
  (system-process-info [feature libuv] [flags])
  (system-path-info [feature libuv] [flags])
  (system-uname [feature libuv] [flags])
  (system-cpu-info [feature libuv] [flags])
  (system-interface-info [feature libuv] [flags])
  (system-resource-usage [feature libuv] [flags])
  (async-loop-metrics [feature libuv] [flags])
)

(define-symbol-flags* ([libraries (chezscheme async io poll)]
                       [flags system proc])
  (fd-poll-open [feature libuv] [flags])
  (fd-poll-handle? [feature libuv] [flags])
  (fd-poll-close [feature libuv] [flags])
  (fd-poll-operation [feature libuv] [flags])
  (fd-poll [feature libuv] [flags])
)

(define-symbol-flags* ([libraries (chezscheme async io process)]
                       [flags system proc])
  (process-spawn [feature libuv] [flags])
  (async-process? [feature libuv] [flags])
  (process-id [feature libuv] [flags])
  (process-wait-operation [feature libuv] [flags])
  (process-wait [feature libuv] [flags])
  (process-kill [feature libuv] [flags])
  (process-id-kill [feature libuv] [flags])
  (process-close [feature libuv] [flags])
)

(define-symbol-flags* ([libraries (chezscheme async io signal)]
                       [flags system proc])
  (signal-open [feature libuv] [flags])
  (signal-watcher? [feature libuv] [flags])
  (signal-receive-operation [feature libuv] [flags])
  (signal-receive [feature libuv] [flags])
  (signal-close [feature libuv] [flags])
)

(define-symbol-flags* ([libraries (chezscheme async io watch)]
                       [flags system proc])
  (fs-event-open [feature libuv] [flags])
  (fs-event-watcher? [feature libuv] [flags])
  (fs-event-receive-operation [feature libuv] [flags])
  (fs-event-receive [feature libuv] [flags])
  (fs-event-close [feature libuv] [flags])
  (fs-poll-open [feature libuv] [flags])
  (fs-poll-watcher? [feature libuv] [flags])
  (fs-poll-receive-operation [feature libuv] [flags])
  (fs-poll-receive [feature libuv] [flags])
  (fs-poll-close [feature libuv] [flags])
)

(define-symbol-flags* ([libraries (chezscheme async io tty)]
                       [flags system proc])
  (tty-open [feature libuv] [flags])
  (tty-stream? [feature libuv] [flags])
  (tty-mode-set! [feature libuv] [flags])
  (tty-window-size [feature libuv] [flags])
  (tty-virtual-terminal-state [feature libuv] [flags])
  (tty-virtual-terminal-state-set! [feature libuv] [flags])
  (tty-reset-mode! [feature libuv] [flags])
)

(define-symbol-flags* ([libraries (chezscheme async io udp)]
                       [flags system proc])
  (udp-open [feature libuv] [flags])
  (udp-socket? [feature libuv] [flags])
  (udp-close [feature libuv] [flags])
  (udp-bind! [feature libuv] [flags])
  (udp-connect! [feature libuv] [flags])
  (udp-disconnect! [feature libuv] [flags])
  (udp-send-operation [feature libuv] [flags])
  (udp-send [feature libuv] [flags])
  (udp-receive-operation [feature libuv] [flags])
  (udp-receive [feature libuv] [flags])
  (udp-local-address [feature libuv] [flags])
  (udp-peer-address [feature libuv] [flags])
  (udp-membership-set! [feature libuv] [flags])
  (udp-multicast-interface-set! [feature libuv] [flags])
  (udp-option-set! [feature libuv] [flags])
)

(define-symbol-flags* ([libraries (chezscheme async io fs)]
                       [flags system proc])
  (async-file? [feature libuv] [flags])
  (file-open-operation [feature libuv] [flags])
  (file-open [feature libuv] [flags])
  (file-read-operation [feature libuv] [flags])
  (file-read [feature libuv] [flags])
  (file-write-operation [feature libuv] [flags])
  (file-write [feature libuv] [flags])
  (file-close-operation [feature libuv] [flags])
  (file-close [feature libuv] [flags])
  (async-file->binary-input-port [feature libuv] [flags])
  (async-file->binary-output-port [feature libuv] [flags])
  (async-file->binary-input/output-port [feature libuv] [flags])
  (file-stat-operation [feature libuv] [flags])
  (file-stat [feature libuv] [flags])
  (file-lstat-operation [feature libuv] [flags])
  (file-lstat [feature libuv] [flags])
  (file-system-stat-operation [feature libuv] [flags])
  (file-system-stat [feature libuv] [flags])
  (file-delete-operation [feature libuv] [flags])
  (file-delete [feature libuv] [flags])
  (file-rename-operation [feature libuv] [flags])
  (file-rename [feature libuv] [flags])
  (file-copy-operation [feature libuv] [flags])
  (file-copy [feature libuv] [flags])
  (directory-create-operation [feature libuv] [flags])
  (directory-create [feature libuv] [flags])
  (directory-delete-operation [feature libuv] [flags])
  (directory-delete [feature libuv] [flags])
  (directory-scan-operation [feature libuv] [flags])
  (directory-scan [feature libuv] [flags])
  (async-directory? [feature libuv] [flags])
  (directory-open-operation [feature libuv] [flags])
  (directory-open [feature libuv] [flags])
  (directory-read-operation [feature libuv] [flags])
  (directory-read [feature libuv] [flags])
  (directory-close-operation [feature libuv] [flags])
  (directory-close [feature libuv] [flags])
  (temporary-directory-create-operation [feature libuv] [flags])
  (temporary-directory-create [feature libuv] [flags])
  (temporary-file-open-operation [feature libuv] [flags])
  (temporary-file-open [feature libuv] [flags])
  (file-sync-operation [feature libuv] [flags])
  (file-sync [feature libuv] [flags])
  (file-data-sync-operation [feature libuv] [flags])
  (file-data-sync [feature libuv] [flags])
  (file-truncate-operation [feature libuv] [flags])
  (file-truncate [feature libuv] [flags])
  (file-send-operation [feature libuv] [flags])
  (file-send [feature libuv] [flags])
  (file-access-operation [feature libuv] [flags])
  (file-access? [feature libuv] [flags])
  (file-mode-set-operation [feature libuv] [flags])
  (file-mode-set! [feature libuv] [flags])
  (file-times-set-operation [feature libuv] [flags])
  (file-times-set! [feature libuv] [flags])
  (file-link-operation [feature libuv] [flags])
  (file-link [feature libuv] [flags])
  (file-symbolic-link-operation [feature libuv] [flags])
  (file-symbolic-link [feature libuv] [flags])
  (file-read-link-operation [feature libuv] [flags])
  (file-read-link [feature libuv] [flags])
  (file-real-path-operation [feature libuv] [flags])
  (file-real-path [feature libuv] [flags])
  (file-owner-set-operation [feature libuv] [flags])
  (file-owner-set! [feature libuv] [flags])
)
...
(define-symbol-flags* ([libraries] [flags system proc]) ; system procedures
  ...
  ($async-sync-slot-ref [flags])
  ($async-sync-slot-delete! [flags])
  ...
  ($async-scheduler-idle-wait [flags])
  ($async-scheduler-timers [flags])
  ($async-scheduler-virtual? [flags])
  ($async-wake-scheduler [flags])
  ($async-scheduler-wake-proc-set! [flags])
  ($async-timer-deadline [flags])
  ...
  ($cost-center-fiber-switch-in! [flags])
  ($cost-center-fiber-switch-out! [flags])
  ($c-error [flags])
  ...
  ($current-native-fiber [flags single-valued])
  ($fiber-switch-prohibited-depth [flags single-valued])
  ($native-fiber-transition [flags single-valued])
  ($native-fiber-claimed [flags single-valued])
  ($native-fiber-claimed-control [flags single-valued])
  ($native-fiber-preempt-active [flags single-valued])
  ($native-fiber-preempt-target [flags single-valued])
  ($native-fiber-preempt-payload [flags single-valued])
  ($call-with-native-fiber-switch-prohibited [flags])
  ($call-with-native-fiber-preemption-window [flags])
  ($native-fiber? [sig [(ptr) -> (boolean)]] [flags pure unrestricted mifoldable])
  ($native-fiber-state [sig [(ptr) -> (symbol)]] [flags single-valued])
  ($native-fiber-owner [sig [(ptr) -> (maybe-fixnum)]] [flags single-valued])
  ($native-fiber-flags [sig [(ptr) -> (fixnum)]] [flags single-valued])
  ($native-fiber-id [sig [(ptr) -> (fixnum)]] [flags single-valued])
  ($native-fiber-stack-snapshot [flags])
  ($native-fiber-adopt [sig [(fixnum) -> (record)]] [flags single-valued])
  ($native-fiber-create [flags single-valued alloc])
  ($native-fiber-try-claim! [flags single-valued])
  ($native-fiber-release-claim! [flags single-valued])
  ($native-fiber-claim-and-switch [flags])
  ($native-fiber-preempt [flags])
  ($native-fiber-switch [flags])
  ($native-fiber-finish [flags])
  ($native-fiber-thread-teardown [flags])
  ...
  ($native-fiber-service-preemption [flags])
  ...
  ($process-event [flags single-valued])
  ...
  ($atomic-box-ref [sig [(box) -> (ptr)]] [flags single-valued])
  ($atomic-box-set! [sig [(box ptr) -> (void)]] [flags single-valued true])
...
(define-symbol-flags* ([libraries] [flags system-keyword])
  ...
  ($chezscheme-async-io-system [flags library-uid])
  ($chezscheme-async-io-poll [flags library-uid])
  ($chezscheme-async-io-process [flags library-uid])
  ($chezscheme-async-io-signal [flags library-uid])
  ($chezscheme-async-io-watch [flags library-uid])
  ($chezscheme-async-io-tty [flags library-uid])
  ($chezscheme-async-io-udp [flags library-uid])
