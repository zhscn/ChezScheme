...
(define-symbol-flags* ([libraries (chezscheme control)] [flags keyword])
  ((control: reset) [flags])
  ((control: shift) [flags])
  ((control: reset-at) [flags])
  ((control: shift-at) [flags])
  ((control: shift/1) [flags])
  ((control: shift/1-at) [flags])
  ((control: reset0) [flags])
  ((control: shift0) [flags])
  ((control: reset0-at) [flags])
  ((control: shift0-at) [flags])
  ((control: shift0/1) [flags])
  ((control: shift0/1-at) [flags])
)

(define-symbol-flags* ([libraries (chezscheme control)] [flags primitive proc])
  ((control: make-continuation-prompt-tag)
    [sig [() (symbol) -> (record)]] [flags alloc])
  ((control: continuation-prompt-tag?)
    [sig [(ptr) -> (boolean)]] [flags pure unrestricted mifoldable discard])
  ((control: default-continuation-prompt-tag)
    [sig [() -> (record)]] [flags pure unrestricted true])
)
...
(define-symbol-flags* ([libraries] [flags primitive proc])
  ...
  (create-exception-state [sig [() (procedure) -> (exception-state)]] [flags alloc])
...
(define-symbol-flags* ([libraries] [flags system proc]) ; system procedures
  ...
  ($control-reset-at [flags])
  ($control-shift-at [flags])
  ($control-shift1-at [flags])
  ($control-shift-native1-at [flags])
  ($control-native1-capture? [flags])
  ($control-native1-capture-ready-at? [flags])
  ($control-resume-native1-at [flags])
