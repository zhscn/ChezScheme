...
(define-symbol-flags* ([libraries (chezscheme async io errors)]
  ...
  (async-io-condition-handle [flags])
  (async-io-condition-path [flags])
...
(define-symbol-flags* ([libraries (chezscheme async io stream)]
  ...
  (tcp-accept-operation [flags])
  (tcp-accept [flags])
  (tcp-connect-operation [flags])
  (tcp-connect [flags])
  (pipe-listen [flags])
  (pipe-connect-operation [flags])
  (pipe-connect [flags])
  (async-stream? [flags])
  (tcp-stream? [flags])
  (pipe-stream? [flags])
  (stream-close [flags])
  (stream-closed? [flags])
  (stream-read-operation [flags])
  (stream-read [flags])
  (stream-write-operation [flags])
  (stream-write [flags])
...
(define-symbol-flags* ([libraries (chezscheme async io dns)]
  ...
  (dns-lookup [flags])
  (dns-reverse-operation [flags])
  (dns-reverse [flags])
)

(define-symbol-flags* ([libraries (chezscheme async io system)]
                       [flags system proc])
  (random-bytevector-operation [flags])
  (random-bytevector [flags])
  (system-high-resolution-time [flags])
  (system-memory-info [flags])
  (system-uptime [flags])
  (system-load-average [flags])
  (system-process-info [flags])
  (system-path-info [flags])
  (system-uname [flags])
  (system-cpu-info [flags])
  (system-interface-info [flags])
  (system-resource-usage [flags])
  (async-loop-metrics [flags])
)

(define-symbol-flags* ([libraries (chezscheme async io poll)]
                       [flags system proc])
  (fd-poll-open [flags])
  (fd-poll-handle? [flags])
  (fd-poll-close [flags])
  (fd-poll-operation [flags])
  (fd-poll [flags])
)
...
(define-symbol-flags* ([libraries (chezscheme async io process)]
  ...
  (async-process? [flags])
  (process-id [flags])
  (process-wait-operation [flags])
  (process-wait [flags])
  (process-kill [flags])
  (process-id-kill [flags])
  (process-close [flags])
)
...
(define-symbol-flags* ([libraries (chezscheme async io signal)]
                       [flags system proc])
  (signal-open [flags])
  (signal-watcher? [flags])
  (signal-receive-operation [flags])
  (signal-receive [flags])
  (signal-close [flags])
)
...
(define-symbol-flags* ([libraries (chezscheme async io watch)]
                       [flags system proc])
  (fs-event-open [flags])
  (fs-event-watcher? [flags])
  (fs-event-receive-operation [flags])
  (fs-event-receive [flags])
  (fs-event-close [flags])
  (fs-poll-open [flags])
  (fs-poll-watcher? [flags])
  (fs-poll-receive-operation [flags])
  (fs-poll-receive [flags])
  (fs-poll-close [flags])
)
...
(define-symbol-flags* ([libraries (chezscheme async io tty)]
  ...
  (tty-stream? [flags])
  (tty-mode-set! [flags])
  (tty-window-size [flags])
  (tty-virtual-terminal-state [flags])
  (tty-virtual-terminal-state-set! [flags])
  (tty-reset-mode! [flags])
)
...
(define-symbol-flags* ([libraries (chezscheme async io udp)]
  ...
  (udp-bind! [flags])
  (udp-connect! [flags])
  (udp-disconnect! [flags])
  (udp-send-operation [flags])
  (udp-send [flags])
  (udp-receive-operation [flags])
  (udp-receive [flags])
  (udp-local-address [flags])
  (udp-peer-address [flags])
  (udp-membership-set! [flags])
  (udp-multicast-interface-set! [flags])
  (udp-option-set! [flags])
)
...
(define-symbol-flags* ([libraries (chezscheme async io fs)]
  ...
  (file-open [flags])
  (file-read-operation [flags])
  (file-read [flags])
  (file-write-operation [flags])
  (file-write [flags])
  (file-close-operation [flags])
  (file-close [flags])
  (async-file->binary-input-port [flags])
  (async-file->binary-output-port [flags])
  (async-file->binary-input/output-port [flags])
  (file-stat-operation [flags])
  (file-stat [flags])
  (file-lstat-operation [flags])
  (file-lstat [flags])
  (file-system-stat-operation [flags])
  (file-system-stat [flags])
  (file-delete-operation [flags])
  (file-delete [flags])
  (file-rename-operation [flags])
  (file-rename [flags])
  (file-copy-operation [flags])
  (file-copy [flags])
  (directory-create-operation [flags])
  (directory-create [flags])
  (directory-delete-operation [flags])
  (directory-delete [flags])
  (directory-scan-operation [flags])
  (directory-scan [flags])
  (async-directory? [flags])
  (directory-open-operation [flags])
  (directory-open [flags])
  (directory-read-operation [flags])
  (directory-read [flags])
  (directory-close-operation [flags])
  (directory-close [flags])
  (temporary-directory-create-operation [flags])
  (temporary-directory-create [flags])
  (temporary-file-open-operation [flags])
  (temporary-file-open [flags])
  (file-sync-operation [flags])
  (file-sync [flags])
  (file-data-sync-operation [flags])
  (file-data-sync [flags])
  (file-truncate-operation [flags])
  (file-truncate [flags])
  (file-send-operation [flags])
  (file-send [flags])
  (file-access-operation [flags])
  (file-access? [flags])
  (file-mode-set-operation [flags])
  (file-mode-set! [flags])
  (file-times-set-operation [flags])
  (file-times-set! [flags])
  (file-link-operation [flags])
  (file-link [flags])
  (file-symbolic-link-operation [flags])
  (file-symbolic-link [flags])
  (file-read-link-operation [flags])
  (file-read-link [flags])
  (file-real-path-operation [flags])
  (file-real-path [flags])
  (file-owner-set-operation [flags])
  (file-owner-set! [flags])
)
