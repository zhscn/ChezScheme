...
(define-hand-coded-library-entry native-fiber-context)
(define-hand-coded-library-entry $native-fiber-allocate-descriptor)
(define-hand-coded-library-entry $native-fiber-make-context)
(define-hand-coded-library-entry $native-fiber-switch-resume-entry)
(define-hand-coded-library-entry $native-fiber-switch-publish-entry)
(define-hand-coded-library-entry $native-fiber-switch-finish-entry)
(define-hand-coded-library-entry $native-fiber-switch-commit-entry)
(define-hand-coded-library-entry $native-fiber-switch-entry)
